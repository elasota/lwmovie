...
{
    public partial class MPEG2VideoOptionsControl : UserControl, ICodecSettingsControl
    {
        ...
        public MPEG2VideoOptionsControl()
        {
            InitializeComponent();
        ...
        {
            MPEG2VideoSettings settings = new MPEG2VideoSettings();
        ...
        {
            MPEG2VideoSettings settings = (MPEG2VideoSettings)planSettings;
