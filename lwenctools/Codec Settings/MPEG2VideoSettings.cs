...
{
    public class MPEG2VideoSettings : IExecutionPlanSettings
    {
        ...
        void IExecutionPlanSettings.CreateCommands(List<ExecutionPlan> plans, Dictionary<string, object> externalSettings, PlanCompletionDelegate pcd)
        {
            ...
            if (TwoPass)
            {
                ...
                // Pass 2
                {
                    ...
                    plan.AddTemporaryFile(outputFile + ".m2v");
                    plans.Add(plan);
                }
            }
            else
            ...
            // M2V import
            {
                ...
                plan.AddCleanupFile(outputFile + ".m2v");
                plans.Add(plan);
            }
        }
        ...
        bool IExecutionPlanSettings.Validate(List<string> outErrors)
        {
            ...
            if (UseCBR)
            {
                ...
                {
                    outErrors.Add("M2V: Bitrate minimum was set higher than bitrate maximum");
                    isOK = false;
                }
            }
            return isOK;
