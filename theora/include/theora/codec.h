 ...
 * \param _alloc The allocator to use for the #th_info info and
 *   anything derived from it.
 */
extern void th_info_init(th_info *_info,const ogg_allocator *_alloc);
 ...
 * \param _alloc The allocator to use for comments.
 */
extern void th_comment_init(th_comment *_tc,const ogg_allocator *_alloc);
