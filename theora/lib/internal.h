...
#  define OC_ALIGN8(expr) LWMOVIE_ATTRIB_ALIGN(8) expr
# endif
# if !defined(OC_ALIGN16)
#  define OC_ALIGN16(expr) LWMOVIE_ATTRIB_ALIGN(16) expr
# endif
...
void *oc_aligned_malloc(size_t _sz,size_t _align,const ogg_allocator *alloc);
void oc_aligned_free(void *_ptr,const ogg_allocator *alloc);
void **oc_malloc_2d(size_t _height,size_t _width,size_t _sz,const ogg_allocator *alloc);
void **oc_calloc_2d(size_t _height,size_t _width,size_t _sz,const ogg_allocator *alloc);
void oc_free_2d(void *_ptr,const ogg_allocator *alloc);
